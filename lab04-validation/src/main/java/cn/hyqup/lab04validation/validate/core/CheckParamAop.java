package cn.hyqup.lab04validation.validate.core;


import cn.hyqup.lab04validation.validate.exception.ParamsCheckException;
import cn.hyqup.lab04validation.validate.exception.ParamsInValidException;
import cn.hyqup.lab04validation.validate.annations.ValidateParam;
import cn.hyqup.lab04validation.validate.annations.ValidateParams;
...
public class CheckParamAop {
    ...
    @Pointcut("@annotation(cn.hyqup.lab04validation.validate.annations.ValidateParam)")
    public void checkParam() {
    }

    @Pointcut("@annotation(cn.hyqup.lab04validation.validate.annations.ValidateParam.List)")
    public void checkParamList() {
    }

    @Pointcut("@annotation(cn.hyqup.lab04validation.validate.annations.ValidateParams)")
