 ...
 */
@Component
public class SpringtHolder implements ApplicationContextAware {

    private static ApplicationContext applicationContext;

    @Override
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        SpringtHolder.applicationContext = applicationContext;
    }
    ...
    private static void assertApplicationContext(String beanName, Class requiredType) {
        if (SpringtHolder.applicationContext == null) {
